...
- Direct analyzer voltage control
- Full device query interface (Groups E/F/G)
- Autosave support for persistent settings
- Example IOC with standard areaDetector plugins
